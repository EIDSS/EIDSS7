...
--##SUMMARY Saves statisic data parsed from csv format.
--##SUMMARY If data contains no error, inserts new record or updates statistic value.
                        

--##REMARKS Author: Zurin M.
--##REMARKS Create date: 21.11.2011
...
CREATE                  PROCEDURE [dbo].[spStatistic_Import](
...
BEGIN
	exec spsysGetNewID @idfStatistic output
