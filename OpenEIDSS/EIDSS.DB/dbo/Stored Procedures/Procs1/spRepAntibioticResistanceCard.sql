...
exec spRepAntibioticResistanceCard 'ru', 'S070120001'

*/

create  Procedure [dbo].[spRepAntibioticResistanceCard]
	(
...
SELECT 
    @strOrganizationAddress = dbo.fnAddressSharedString(@LangID, tlbOffice.idfLocation),
