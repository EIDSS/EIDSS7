...
exec spRepHumMonthlyInfectiousDiseaseNew 'en', '2010-01-01', '2013-02-01',  null, null

exec spRepHumMonthlyInfectiousDiseaseNew 'en', '2010-01-01', '2015-02-01',  null, null
*/

create  Procedure [dbo].[spRepHumMonthlyInfectiousDiseaseNew]
	(
...
SET @idfsCustomReportType = 10290009 /*GG Report on Certain Diseases/Conditions (Monthly Form IV–03)*/
...
--if @idfsLanguage = 10049004  set @na = N'ა/შ' else set @na = N'N/A'
