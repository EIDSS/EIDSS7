...
exec spRepHumAnnualInfectiousDisease 'en', '2011-09-01', '2011-10-01',  37050000000, 3450000000
exec spRepHumAnnualInfectiousDisease 'en', '2011-09-01', '2015-10-01',  null, null
...
--    AND trtd.intRowStatus = 0 -- updated 26-02-2013
...
FROM dbo.trtReportRows rr
    ...
    ON br.idfsBaseReference = rr.idfsDiagnosisOrReportDiagnosisGroup
        ...
        --AND br.intRowStatus = 0 -- updated 10-01-2013
    INNER JOIN trtDiagnosis trtd
    ON trtd.idfsDiagnosis = rr.idfsDiagnosisOrReportDiagnosisGroup 
        --AND trtd.intRowStatus = 0 -- updated 10-01-2013
WHERE  rr.idfsCustomReportType = @idfsCustomReportType 
...
/*
trtReportRows.intNullValueInsteadZero:
  strICD10 : 0 или 1
  intLabTested : 0 или 2
  intLabConfirmed : 0 или 4
  intTotalConfirmed: 0 или 8
*/		
update		ft
set	
