...
CREATE	procedure	[dbo].[spPatient_CanDelete]
( 
...
if	exists	(
		...
		or exists	(
			...
			on			tlbHuman.idfHumanActual = tlbHumanActual.idfHumanActual
...
BEGIN
	...
	EXEC @DataValidationResult = spPatient_Validate @ID
