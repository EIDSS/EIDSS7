...
exec spRepHumMonthlyInfectiousDiseaseV6 'en', 10290037, '2015-06-01', '2015-06-30',  37060000000, 3580000000


exec spRepHumMonthlyInfectiousDiseaseV6 'en', 10290037, '2015-06-01', '2015-06-30',  37060000000, 3550000000
...
exec spRepHumMonthlyInfectiousDiseaseV6 'en', 10290037, '2009-06-01', '2009-06-30',  37060000000, 3580000000


exec spRepHumMonthlyInfectiousDiseaseV6 'en', 10290038, '2015-04-01', '2015-09-01',  null, null



*/

create  Procedure [dbo].[spRepHumMonthlyInfectiousDiseaseV6]
	(
		@LangID		as nvarchar(10), 
		@idfsCustomReportType as bigint, -- 10290037 = "Form 03 by MoLHSA Order 01-82N", 10290038 = "Intermediate Form 03 by MoLHSA Order 01-82N"
...
--		,  cast(20* RAND(CHECKSUM(NEWID())) as int)
--		,  cast(5* RAND(CHECKSUM(NEWID())) as int)
--		,  cast(5* RAND(CHECKSUM(NEWID())) as int)
--		,  cast(5* RAND(CHECKSUM(NEWID())) as int)
--		, intOrder
...
--exec spDiagnosis_SelectLookup 'en'
