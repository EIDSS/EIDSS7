...
*/
CREATE PROCEDURE [dbo].[spValidateMandatoryFields]
...
SET @CreationDateStart = ISNULL(dbo.fn_SetMinMaxTime(CAST(@CreationDateStart AS DATETIME),0), '1753-01-01 00:00:00.000')
SET @CreationDateEnd = ISNULL(dbo.fn_SetMinMaxTime(CAST(@CreationDateEnd AS DATETIME),1), '9999-12-31 00:00:00.000')
SET @ModificationDateStart = ISNULL(dbo.fn_SetMinMaxTime(CAST(@ModificationDateStart AS DATETIME),0), '1753-01-01 00:00:00.000')
SET @ModificationDateEnd = ISNULL(dbo.fn_SetMinMaxTime(CAST(@ModificationDateEnd AS DATETIME),1), '9999-12-31 00:00:00.000')
