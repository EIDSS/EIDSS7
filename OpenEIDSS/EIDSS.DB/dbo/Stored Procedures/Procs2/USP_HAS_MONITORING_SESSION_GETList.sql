...
BEGIN
	...
	BEGIN TRY  	
		...
		SELECT					ms.idfMonitoringSession AS HumanMonitoringSessionID,
								...
								ms.idfsMonitoringSessionStatus AS StatusTypeID,
								...
								campaign.strCampaignID AS EIDSSCampaignID,
								ISNULL(person.strFirstName, '') + ' ' + ISNULL(person.strFamilyName, '') AS PersonEnteredByName,
								siteRef.FullName AS SiteName 
		...
		ORDER BY				ms.idfMonitoringSession
