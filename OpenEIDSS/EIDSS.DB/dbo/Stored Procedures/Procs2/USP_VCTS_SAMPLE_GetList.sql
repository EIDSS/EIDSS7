...
--
-- Testing code:
--EXECUTE USP_VCTS_SAMPLE_GetList @idfVector,'en'
--*************************************************************
...
BEGIN
	...
	BEGIN TRY  	
		...
		--LEFT JOIN	dbo.FN_GBL_Reference_List_GET(@LangID,19000045) CollectedByOffice	ON CollectedByOffice.idfsReference = Samples.idfFieldCollectedByOffice 
