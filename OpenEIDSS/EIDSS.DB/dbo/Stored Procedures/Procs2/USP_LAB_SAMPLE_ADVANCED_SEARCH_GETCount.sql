...
-- ================================================================================================
-- Name: USP_LAB_SAMPLE_ADVACNED_SEARCH_GETCount
--
-- Description:	Get sample advanced search count for the laboratory module use case LUC13.
--                      
-- Revision History:
...
-- ================================================================================================
CREATE PROCEDURE [dbo].[USP_LAB_SAMPLE_ADVANCED_SEARCH_GETCount] (
