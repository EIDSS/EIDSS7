...
-- ============================================================================
-- Name: USSP_VCT_MONITORINGSESSION_SUMMARY_DEL
-- Description:	Sets a monitoring session summary record to "inactive".
--                      
-- Author: Stephen Long
-- Revision History:
...
-- ============================================================================
CREATE PROCEDURE [dbo].[USSP_VCT_MONITORINGSESSION_SUMMARY_DEL]
(	 
