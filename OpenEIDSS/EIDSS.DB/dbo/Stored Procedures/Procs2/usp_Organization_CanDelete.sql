...
SET @ID = 758210000000
exec dbo.usp_Organization_CanDelete @ID, @Result Output

Print @Result
*/

CREATE            PROCEDURE [dbo].[usp_Organization_CanDelete]( 
...
BEGIN
	...
	EXEC @DataValidationResult = usp_Organization_Validate @ID -- renamed sp call to usp_
