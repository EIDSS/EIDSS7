...
{
    public class VctsVectStructuredSetParams
    {
        ...
        public System.DateTime datIdentIFiedDateTime{get;set;}
        ...
        public System.Data.DataTable sample{get;set;}
        public System.Data.DataTable fieldTest { get; set; }
    }
}
