...
{
    /// <summary>
    /// Body parameters used with a call to the LaboratoryController.LaboratorySampleGetListAsync service method
    /// </summary>
    public sealed class LaboratorySampleGetListParameters
    {
        [Required]
