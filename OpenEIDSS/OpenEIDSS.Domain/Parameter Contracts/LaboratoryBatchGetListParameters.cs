...
{
    /// <summary>
    /// Body parameters used with a call to the LaboratoryController.LaboratoryBatchGetListAsync service method
    /// </summary>
    public sealed class LaboratoryBatchGetListParameters
    {
        [Required]
