...
{
    /// <summary>
    /// Body parameters used with a call to the LaboratoryController.LaboratoryTestGetListAsync service method
    /// </summary>
    public sealed class LaboratoryTestGetListParameters
    {
        [Required]
