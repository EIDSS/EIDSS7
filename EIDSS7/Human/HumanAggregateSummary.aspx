<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NormalView.Master" CodeBehind="HumanAggregateSummary.aspx.vb" Inherits="EIDSS.HumanAggregate" %>

<%@ Register Src="~/Controls/LocationUserControl.ascx" TagPrefix="eidss" TagName="LocationUserControl" %>
<%@ Register Src="~/Controls/FFHumanAggregateMatrix.ascx" TagPrefix="eidss" TagName="HumanAggregateMatrix" %>
...
<%--                                                    <asp:label meta:resourcekey="lbl_Year" runat="server"></asp:label>--%>
                                        ...
                                        <div class="form-group">
                                            <div class="table-responsive">
                                                ...
                                                <!-- Arnold : Please move the hardcoded values to Resource file please - I am naming them standard way, please change the text as needed -->

                                                <%--                                                <label for="hdfRiskFactor" runat="server" meta:resourcekey="lbl_List_of_Risks"></label>
                                                <eidss:HumanAggregateMatrix runat="server" 
                                                ...
                                                <asp:GridView ID="gvDiagnosis" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner1" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner2" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner3" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner4" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner5" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner6" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner7" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner8" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner9" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner10" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner11" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner12" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner13" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner14" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner15" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner16" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner17" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner18" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner19" runat="server" CssClass="form-control" Enabled="false"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <%--<asp:TemplateField>
                                                            <HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField>
                                                            ...
                                                            <ItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner20" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner21" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <ItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner22" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner23" runat="server" CssClass="form-control"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderStyle VerticalAlign="Bottom" />
                                                            ...
                                                            <ItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner24" runat="server" CssClass="form-control" Enabled="false"></eidss:NumericSpinner>
                                                            </ItemTemplate>
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner25" runat="server" CssClass="form-control" Enabled="false"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                            ...
                                                            <EditItemTemplate>
                                                                <eidss:NumericSpinner ID="NumericSpinner26" runat="server" CssClass="form-control" Enabled="false"></eidss:NumericSpinner>
                                                            </EditItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
                                                </asp:GridView>
