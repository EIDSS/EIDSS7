<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NormalView.Master" CodeBehind="HumanAggSummary.aspx.vb" Inherits="EIDSS.HumanAggSummary" %>
            ...
            <div class="container col-md-12">
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <asp:HiddenField runat="server" ID="hdnCaseReportUID" />
                        <asp:HiddenField runat="server" ID="hdnCaseReportSummaryCount" />
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <eidss:GridView ID="gvHAC"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="<%$ Resources:lbl_CheckCase_ID.InnerText %>" ItemStyle-Width="30">
                                                               <ItemTemplate>
                                                                  <asp:CheckBox ID="chkCaseSummary" name="chkCase"  ToolTip="Add to Summary List" runat="server" AutoPostBack="false" Value='<%#Eval("strCaseID")%>' OnCheckedChanged="chkCaseSummary_Click" />

<%--                                                                  <asp:CheckBox ID="chkCaseSummary" runat="server" AutoPostBack="true" Value='<%#Eval("strCaseID")%>' onclick="javascript:clearContactSelections(this);"  OnCheckedChanged="chkCaseSummary_Click"  />--%>
                                                                </ItemTemplate>
                                                         </asp:TemplateField>		
                                    ...
                                    <asp:Button ID="btnShowSummary" runat="server" CssClass="btn btn-primary" meta:resourceKey="btn_Show_Summary" OnClick="btnShowSummary_Click" />
                                  <%--<asp:Button ID="btnCalculateSummary" runat="server" CssClass="btn btn-primary" meta:resourceKey="btn_Calculate_Summary" OnClick="btnCalculateSummary_Click" />--%>  
                  ...
                  <div id="selectedResults" class="embed-panel" runat="server" visible="false">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <h3 id="h1" runat="server" meta:resourcekey="hdg_Selected_Results"></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="panel-body">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <eidss:GridView ID="gvSelectedHAC"
                                                    runat="server"
                                                    AllowPaging="True"
                                                    PagerSettings-Visible="false"
                                                    AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField ItemStyle-Width="10">
                                                               <ItemTemplate>
                                                                  <asp:CheckBox ID="chkCaseSelectedSummary" runat="server" AutoPostBack="true" Value='<%#Eval("strCaseID")%>' onclick="javascript:clearContactSelections(this);"  OnCheckedChanged="chkCaseSelectedSummary_Click"  />
                                                                </ItemTemplate>
                                                         </asp:TemplateField>		
                                                ...
                                                <div class="row">
                                                      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 text-right">
                                                        <label><%= GetGlobalResourceObject("Labels", "Lbl_Page_Text") %></label>&nbsp;<asp:Label ID="Label1" runat="server" CssClass="control-label"></asp:Label>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 text-right">
...
<%--                                  <asp:Button ID="btnCalculateSummary" runat="server" CssClass="btn btn-primary" meta:resourceKey="btn_Calculate_Summary" OnClick="btnCalculateSummary_Click" />  --%>
                                ...
                                <div class="row text-center">
                                    <asp:Button ID="btnSelectAll" runat="server" CssClass="btn btn-default" meta:resourceKey="btn_SelectAll" OnClick="btnSelectAll_Click" Visible="false" />
                                    <asp:Button ID="btnSelect" runat="server" CssClass="btn btn-default" meta:resourceKey="btn_Select" OnClick="btnSelect_Click" Visible="false" />
                                    <asp:Button ID="btnCalculateSummary" runat="server" CssClass="btn btn-primary" meta:resourceKey="btn_Calculate_Summary" OnClick="btnCalculateSummary_Click" Visible="false"/>  
               ...
               function clearContactSelections(object) {
                ...
                function showSearchCriteria(e) {
                    ...
                    if (cl == 'glyphicon glyphicon-triangle-bottom header-button') {
                        ...
                        $('#<%= btnSelect.ClientID %>').hide();
                         $('#<%= btnSelectAll.ClientID %>').hide();
                    }
                    else {
                        ...
                        $('#<%= btnSelect.ClientID %>').show();
                         $('#<%= btnSelectAll.ClientID %>').show();
                    }
                };
