<%@ Page Title="Avian Veterinary Disease Report" Language="vb" AutoEventWireup="false" MasterPageFile="~/NormalView.Master" CodeBehind="AvianDiseaseReport.aspx.vb" Inherits="EIDSS.AvianDiseaseReport" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="EIDSSBodyCPH" runat="server">
    <asp:UpdatePanel ID="upHiddenFields" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <div id="divHiddenFieldsSection" runat="server" visible="false">
                ...
                <asp:HiddenField ID="hdfReportCategoryTypeID" runat="server" Value="10012004" />
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2 runat="server" meta:resourcekey="Hdg_Avian_Disease_Report"></h2>
        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" runat="server" meta:resourcekey="Dis_Field_Accession_ID">
                                                                    ...
                                                                    <label for="<%= txtEIDSSFieldAccessionID.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Field_Accession_ID_Text") %></label>
                                                                ...
                                                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" runat="server" meta:resourcekey="Dis_Outbreak_ID">
                                                                    ...
                                                                    <label for="<%= txtEIDSSOutbreakID.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Outbreak_ID_Text") %></label>
                                                                ...
                                                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" runat="server" meta:resourcekey="Dis_Session_ID">
                                                                    ...
                                                                    <label for="<%= txtEIDSSParentMonitoringSessionID.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Session_ID_Text") %></label>
                                                                ...
                                                                <div id="divLegacyID" class="col-lg-3 col-md-3 col-sm-12 col-xs-12" runat="server" meta:resourcekey="Dis_Legacy_ID">
                                                                    <label runat="server" for="<%= txtLegacyID.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Legacy_ID_Text") %></label>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6" runat="server" meta:resourcekey="Dis_Diagnosis_Date">
                                                                    ...
                                                                    <label for="<%= txtDiagnosisDate.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Date_Of_Diagnosis_Text") %></label>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="sectionContainer expanded">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" runat="server" meta:resourcekey="Dis_Reported_By_Organization">
                                                                        ...
                                                                        <label for="<%= ddlReportedByOrganizationID.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Organization_Text") %></label>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" runat="server" meta:resourcekey="Dis_Reported_By_Person">
                                                                        ...
                                                                        <label for="<%= ddlReportedByPersonID.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Reported_By_Text") %></label>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" runat="server" meta:resourcekey="Dis_Initial_Report_Date">
                                                                        ...
                                                                        <label for="<%= txtReportDate.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Initial_Report_Date_Text") %></label>
                                                                        <eidss:CalendarInput ID="txtReportDate" runat="server" ContainerCssClass="input-group datepicker" CssClass="form-control" MaxDate='<%# Date.Today %>'></eidss:CalendarInput>
                                                                        <asp:RequiredFieldValidator runat="server" CssClass="text-danger" ControlToValidate="txtReportDate" ValidationGroup="Notification" Display="Dynamic" meta:resourceKey="Val_Initial_Report_Date" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                            ...
                                                            <div class="form-group" runat="server">
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" runat="server" meta:resourcekey="Dis_Investigated_By_Organization">
                                                                        ...
                                                                        <label for="<%= ddlInvestigatedByOrganizationID.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Investigation_Organization_Text") %></label>
                                                                    ...
                                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" runat="server" meta:resourcekey="Dis_Investigated_By_Person">
                                                                        ...
                                                                        <label for="<%= ddlInvestigatedByPersonID.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Investigator_Name_Text") %></label>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" runat="server" meta:resourcekey="Dis_Assigned_Date">
                                                                        ...
                                                                        <label for="<%= txtAssignedDate.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Assigned_Date_Text") %></label>
                                                                        <eidss:CalendarInput ID="txtAssignedDate" runat="server" ContainerCssClass="input-group datepicker" CssClass="form-control" MaxDate='<%# Date.Today %>'></eidss:CalendarInput>
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" runat="server" meta:resourcekey="Dis_Investigation_Date">
                                                                        ...
                                                                        <label for="<%= txtInvestigationDate.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Investigation_Date_Text") %></label>
                                                                        <eidss:CalendarInput ID="txtInvestigationDate" runat="server" ContainerCssClass="input-group datepicker" CssClass="form-control" MaxDate='<%# Date.Today %>'></eidss:CalendarInput>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                        <label for="<%= txtSiteName.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Site_Text") %></label>
                                                                        <asp:TextBox ID="txtSiteName" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                        <label for="<%= txtEnteredByPersonName.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Officer_Text") %></label>
                                                                        <asp:TextBox ID="txtEnteredByPersonName" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                                        <label for="<%= txtEnteredDate.ClientID %>" class="control-label"><%= GetGlobalResourceObject("Labels", "Lbl_Entered_Date_Text") %></label>
                                            ...
                                            <section id="FarmFlockSpecies" runat="server" class="col-md-12 hidden">
                                                <asp:UpdatePanel ID="upFarmFlockSpecies" runat="server" UpdateMode="Conditional">
                                                    <Triggers>
                                                    </Triggers>
                                                    <ContentTemplate>
                                                        <div class="panel panel-default">
                                                            <div class="panel-heading">
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                        <h3 runat="server" meta:resourcekey="Hdg_Farm_Flock_Species"></h3>
                                                                    </div>
                                                            ...
                                                            <div class="panel-body" style="z-index: 0 !important;">
                                                                <div class="table-responsive" style="z-index: 0 !important;">
                                                                    <eidss:GridView ID="gvFlocks" runat="server" AllowPaging="False" AllowSorting="False" AutoGenerateColumns="False" CssClass="table table-striped"
                                                                        DataKeyNames="HerdMasterID" GridLines="None" ShowFooter="true" UseAccessibleHeader="true">
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField ItemStyle-Width="100%">
                                                                                <HeaderTemplate>
                                                                                    ...
                                                                                    <div class="col-lg-1">
                                                                                        <label><% =GetGlobalResourceObject("Labels", "Lbl_Average_Age_Weeks_Text") %></label>
                                                                                    </div>
                                                                                ...
                                                                                <ItemTemplate>
                                                                                    <div class="row">
                                                                                        <div class="col-lg-4">
                                                                                            <asp:Label runat="server" ID="lblEIDSSHerdID" CssClass="control-label"></asp:Label>
                                                                                            <asp:HiddenField ID="hdfHerdMasterID" runat="server" Value='<% #Eval("HerdMasterID") %>' />
                                                                                        </div>
                                                                                        <div class="col-lg-1">
                                                                                            <asp:Label runat="server" ID="lblTotalAnimalQuantity" Text='<% #Eval("TotalAnimalQuantity") %>' CssClass="control-label"></asp:Label>
                                                                                        </div>
                                                                                        <div class="col-lg-1">
                                                                                            <asp:Label runat="server" ID="lblDeadAnimalQuantity" Text='<% #Eval("DeadAnimalQuantity") %>' CssClass="control-label"></asp:Label>
                                                                                        </div>
                                                                                        <div class="col-lg-1">
                                                                                            <asp:Label runat="server" ID="lblSickAnimalQuantity" Text='<% #Eval("SickAnimalQuantity") %>' CssClass="control-label"></asp:Label>
                                                                                        </div>
                                                                                                ...
                                                                                                <ItemTemplate>
                                                                                                    <asp:UpdatePanel ID="upSpecies" runat="server" UpdateMode="Conditional">
                                                                                                        <Triggers>
                                                                                                            ...
                                                                                                            <asp:AsyncPostBackTrigger ControlID="txtAverageAge" EventName="TextChanged" />
                                                                                                        </Triggers>
                                                                                                        <ContentTemplate>
                                                                                                            <div class="row">
                                                                                                                <div class="col-lg-4">
                                                                                                                ...
                                                                                                                <div class="col-lg-1">
                                                                                                                    <eidss:NumericSpinner ID="txtAverageAge" runat="server" CssClass="form-control" Text='<% #Bind("AverageAge") %>' MinValue="0" Height="33" Width="33" OnTextChanged="SpeciesControlEventHandler"></eidss:NumericSpinner>
                                                                                                                    <asp:RequiredFieldValidator ControlToValidate="txtAverageAge" CssClass="alert-danger" Display="Dynamic" meta:resourcekey="Val_Average_Age" runat="server" ValidationGroup="FarmHerdSpeciesSection"></asp:RequiredFieldValidator>
                                                                                                                </div>
                                                                                                                <div class="col-lg-1">
                                                    ...
                                                    <div class="panel-heading">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 pull-right">
                                                                <asp:Button ID="btnClearFarmEpidemiologicalInfo" runat="server" CssClass="btn btn-primary btn-sm" Text="<%$ Resources: Buttons, Btn_Clear_Text %>" ToolTip="<%$ Resources: Buttons, Btn_Clear_ToolTip %>" />
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            <asp:UpdatePanel ID="upFarmEpidemiologicalInfo" runat="server" UpdateMode="Conditional">
                                                                <ContentTemplate>
                                                                    <eidss:FlexForm runat="server" ID="ucFarmEpidemiologicalInfo" LegendHeader="" FormType="10034007" />
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="form-group">
                                                            <asp:UpdatePanel ID="upSpeciesClinicalInvestigation" runat="server" UpdateMode="Conditional">
                                                                ...
                                                                <ContentTemplate>
                                                                    <eidss:FlexForm runat="server" ID="ucSpeciesClinicalInvestigation" LegendHeader="" FormType="10034008" />
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="table-responsive">
                                                                    <eidss:GridView ID="gvSamples" runat="server" AllowPaging="False" AllowSorting="True" AutoGenerateColumns="False" CaptionAlign="Top" CssClass="table table-striped" DataKeyNames="SampleID" EmptyDataText="<%$ Resources: Labels, Lbl_No_Results_Found_Text %>" ShowHeader="true" ShowHeaderWhenEmpty="true" ShowFooter="True" GridLines="None">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField DataField="BirdStatusTypeName" HeaderText="<%$ Resources: Grd_Samples_List_Bird_Status_Heading %>" />
                                                                ...
                                                                <div class="table-responsive">
                                                                    <eidss:GridView ID="gvLabTests" runat="server" AllowPaging="False" AllowSorting="True" AutoGenerateColumns="False" CaptionAlign="Top" CssClass="table table-striped" DataKeyNames="TestID" EmptyDataText="<%$ Resources: Labels, Lbl_No_Results_Found_Text %>" ShowHeader="true" ShowHeaderWhenEmpty="true" ShowFooter="True" GridLines="None">
                                                                        ...
                                                                        <Columns>
                                                                            ...
                                                                            <asp:BoundField DataField="SpeciesTypeName" HeaderText="<%$ Resources: Grd_Lab_Tests_List_Species_Heading %>" meta:resourcekey="Dis_Lab_Test_Species" />
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="table-responsive">
                                                                    <eidss:GridView ID="gvTestInterpretations" runat="server" AllowPaging="False" AllowSorting="True" AutoGenerateColumns="False" CaptionAlign="Top" CssClass="table table-striped" DataKeyNames="TestInterpretationID" EmptyDataText="<%$ Resources: Labels, Lbl_No_Results_Found_Text %>" ShowHeader="true" ShowHeaderWhenEmpty="true" ShowFooter="True" GridLines="None">
                                                                        ...
                                                                        <SortedDescendingHeaderStyle CssClass="glyphicon glyphicon-triangle-bottom" />
                                                                        <Columns>
                                                                            <asp:BoundField DataField="SpeciesTypeName" HeaderText="<%$ Resources: Grd_Interpretations_List_Species_Heading %>" meta:resourcekey="Dis_Lab_Test_Species" />
                    ...
                    <div id="divSampleForm" class="modal-body" runat="server">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" meta:resourcekey="Dis_Bird_Status" runat="server">
                                    <div class="glyphicon glyphicon-asterisk alert-danger" meta:resourcekey="Req_Bird_Status" runat="server"></div>
                                    <asp:Label AssociatedControlID="ddlSampleBirdStatusTypeID" CssClass="control-label" meta:resourcekey="Lbl_Bird_Status" runat="server"></asp:Label>
                                    <eidss:DropDownList CssClass="form-control" ID="ddlSampleBirdStatusTypeID" runat="server"></eidss:DropDownList>
                                    <asp:RequiredFieldValidator ControlToValidate="ddlSampleBirdStatusTypeID" CssClass="alert-danger" Display="Dynamic" InitialValue="null" meta:resourcekey="Val_Bird_Status" runat="server" ValidationGroup="SamplesSection"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <asp:UpdatePanel ID="upPensideTestModal" runat="server" UpdateMode="Conditional">
                ...
                <ContentTemplate>
                    <div id="divPensideTestForm" class="modal-body" runat="server">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" meta:resourcekey="Dis_Penside_Test_Species" runat="server">
                                    <div class="glyphicon glyphicon-asterisk alert-danger" meta:resourcekey="Req_Penside_Test_Species" runat="server"></div>
                                    <asp:Label AssociatedControlID="txtPensideTestSpecies" CssClass="control-label" meta:resourcekey="Lbl_Species" runat="server"></asp:Label>
                                    <asp:TextBox CssClass="form-control" ID="txtPensideTestSpecies" runat="server" Enabled="false"></asp:TextBox>
                                    <asp:RequiredFieldValidator ControlToValidate="txtPensideTestSpecies" CssClass="alert-danger" Display="Dynamic" InitialValue="null" meta:resourcekey="Val_Penside_Test_Species" runat="server" ValidationGroup="PensideTestsSection"></asp:RequiredFieldValidator>
                                </div>
            ...
            <asp:UpdatePanel ID="upLabTestModal" runat="server" UpdateMode="Conditional">
                ...
                <ContentTemplate>
                    <div id="divLabTestForm" class="modal-body" runat="server">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" meta:resourcekey="Dis_Lab_Test_Species" runat="server">
                                    <div class="glyphicon glyphicon-asterisk alert-danger" meta:resourcekey="Req_Lab_Test_Species" runat="server"></div>
                                    <asp:Label AssociatedControlID="txtLabTestSpecies" CssClass="control-label" meta:resourcekey="Lbl_Species" runat="server"></asp:Label>
                                    <asp:TextBox ID="txtLabTestSpecies" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                                    <asp:RequiredFieldValidator ControlToValidate="txtLabTestSpecies" CssClass="alert-danger" Display="Dynamic" meta:resourcekey="Val_Lab_Test_Species" runat="server" ValidationGroup="LabTestSection"></asp:RequiredFieldValidator>
                                </div>
