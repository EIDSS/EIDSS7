<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NormalView.Master" CodeBehind="VeterinaryAggregateCase.aspx.vb" Inherits="EIDSS.VeterinaryAggregate" %>
...
<%--                                            <div class="form-group">
                            ...
                            <div id="VeterinaryAggregate" class="embed-panel" runat="server" visible="false">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <!-- For some reason in resx file ===> dis_Case_ID.Visible = false -->
                                        <%--<div class="form-group" runat="server" meta:resourcekey="dis_Case_ID">--%>
                                        <div class="form-group" runat="server">
                                            <div class="row">
                                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                    <label runat="server" meta:resourcekey="lbl_Report_ID"></label>
                                                    <asp:TextBox ID="txtstrCaseID" runat="server" CssClass="form-control" Enabled="false" Visible="true"></asp:TextBox>
                                                </div>
                                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                    <label runat="server" meta:resourcekey="lbl_Country_Text"></label>
                                                    <asp:TextBox ID="txtstrCountry" runat="server" CssClass="form-control" Enabled="false" Visible="true"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" runat="server" meta:resourcekey="req_fields">
                                            <div class="row">
                                                ...
                                                <div id="month" class="col-lg-3 col-md-3 col-sm-3 col-xs-12" meta:resourcekey="dis_Month" runat="server" visible="True">
                                                    ...
                                                    <asp:DropDownList ID="ddlintMonth" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="SaveDateRangeFromDDL" Visible="True"></asp:DropDownList>
                                                ...
                                                <div id="quarter" class="col-lg-3 col-md-3 col-sm-3 col-xs-12" runat="server" meta:resourcekey="dis_Quarter" visible="False">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="valQuarter" runat="server" ControlToValidate="ddlintQuarter" CssClass="text-danger" InitialValue="null" meta:resourceKey="val_Quarter" ></asp:RequiredFieldValidator>
                                                </div>
                                                ...
                                                <div id="singleDay" class="col-lg-3 col-md-3 col-sm-3 col-xs-12" runat="server" meta:resourcekey="dis_Day" visible="False">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="valDay" runat="server" ControlToValidate="txtdatDate" CssClass="text-danger" InitialValue="null" meta:resourceKey="val_Day" ></asp:RequiredFieldValidator>                                                </div>
                                            </div>
                                        </div>
                                        <!-- LocationUserControl-->
                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <fieldset style="overflow: auto;">
                                                            <legend>
                                                                <asp:Label runat="server" ID="lbl_legend_title"> Veterinary Aggregate Flex Form </asp:Label></legend>
