        ...
        Public Function ListAll(Optional args() As String = Nothing) As DataSet Implements IEidssEntity.ListAll
            ...
            Try
                ...
                If Not (args Is Nothing) Then
                    ...
                    KeyValPair.Add(New clsCommon.Param() With {.ParamName = "@RegionID", .ParamValue = args(0).ToString(), .ParamMode = "IN"})

                    Dim oTuple = oService.GetData(GetCurrentCountry(), "RayonList", oComm.KeyValPairToString(KeyValPair))
                    oDS = oTuple.m_Item1
                    oDS.CheckDataSet()
