    ...
    Public Class clsPostalCode
        ...
        Public Function ListAll(Optional args() As String = Nothing) As DataSet Implements IEidssEntity.ListAll
            ...
            Try
                ...
                KeyValPair.Add(New clsCommon.Param() With {.ParamName = "@SettlementID", .ParamValue = args(0).ToString(), .ParamMode = "IN"})
                Dim oTuple = oService.GetData(GetCurrentCountry(), "PostalCodeList", oComm.KeyValPairToString(KeyValPair))
                oDS = oTuple.m_Item1
                oDS.CheckDataSet()
