...
Namespace EIDSS
    Public Class clsReportDiagnosisGroupReference
        ...
        Public Function ListAll(Optional args() As String = Nothing) As DataSet Implements IEidssEntity.ListAll
            ...
            Try
                ...
                Dim oTuple = oService.GetData(GetCurrentCountry(), "ReportDiagnosisGroupLookup", oComm.KeyValPairToString(KeyValPair))
                oDS = oTuple.m_Item1
                oDS.CheckDataSet()
        ...
        Public Function AddorUpdate(ByVal strParams As String, ByRef returnObject As Object) As Int32
            ...
            Try
                ...
                KeyValPair.Add(New clsCommon.Param() With {.ParamName = "@LangId", .ParamValue = GetCurrentLanguage(), .ParamMode = "IN"})
                Dim oTuple = oService.GetData(GetCurrentCountry(), "ReportDiagnosisGroupSet", strParams & "|" & oComm.KeyValPairToString(KeyValPair))
        ...
        Public Function CurrentlyInUse(ByVal id As Double) As Boolean
            ...
            Try
                ...
                Dim oDS As DataSet
                Dim KeyValPair As New List(Of clsCommon.Param)
                KeyValPair.Add(New clsCommon.Param() With {.ParamName = "@idfsReportDiagnosisGroup", .ParamValue = id, .ParamMode = "IN"})
                Dim oTuple = oService.GetData(GetCurrentCountry(), "ReportDiagnosisGroupInUse", oComm.KeyValPairToString(KeyValPair))
                oDS = oTuple.m_Item1
        ...
        Public Function Delete(ByVal id As Double) As Boolean
            ...
            Try
                ...
                Dim KeyValPair As New List(Of clsCommon.Param)
                KeyValPair.Add(New clsCommon.Param() With {.ParamName = "@idfsReportDiagnosisGroup", .ParamValue = id, .ParamMode = "IN"})
                Dim oTuple = oService.GetData(GetCurrentCountry(), "ReportDiagnosisGroupDelete", oComm.KeyValPairToString(KeyValPair))
                oDS = oTuple.m_Item1
                oDS.CheckDataSet()
        ...
        Public Function DoesExist(ByVal name As String) As Boolean
            ...
            Try
                ...
                Dim oTuple = oService.GetData(GetCurrentCountry(), "ReportDiagnosisGroupDoesExist", oComm.KeyValPairToString(KeyValPair))
                oDS = oTuple.m_Item1
