    ...
    Public Class clsSpecies
        ...
        Public Function ListAll(Optional args() As String = Nothing) As DataSet Implements IEidssEntity.ListAll
            ...
            Try
                ...
                KeyValPair.Add(New clsCommon.Param() With {.ParamName = "@idfsVectorType", .ParamValue = args(0).ToString().ToInt64, .ParamMode = "IN"})
                Dim oTuple = oService.GetData(GetCurrentCountry(), "SpeciesList", oComm.KeyValPairToString(KeyValPair))
                oDS = oTuple.m_Item1
                oDS.CheckDataSet()
