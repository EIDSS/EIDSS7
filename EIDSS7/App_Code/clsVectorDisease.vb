    ...
    Public Class clsVectorDisease
        ...
        Public Function ListAll(Optional args() As String = Nothing) As DataSet Implements IEidssEntity.ListAll
            ...
            Try
                ...
                KeyValPair.Add(New clsCommon.Param() With {.ParamName = "@idfsVSSessionSummary", .ParamValue = args(0).ToString(), .ParamMode = "IN"})
                Dim oTuple = oService.GetData(GetCurrentCountry(), "VectorDiseasesGetList", oComm.KeyValPairToString(KeyValPair))
                oDS = oTuple.m_Item1
                oDS.CheckDataSet()
