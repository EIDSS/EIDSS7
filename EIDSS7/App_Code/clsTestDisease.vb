...
#Region "Global Values"
        ...
        Private Const TEST_DISEASE_GET_LIST_SP As String = "TestDiseaseGetList"
        Private Const TEST_DISEASE_GET_DETAIL_SP As String = "TestDiseaseGetDetail"
...
#Region "Get Methods"
        ...
        Public Function ListAll(Optional args() As String = Nothing) As DataSet Implements IEidssEntity.ListAll
            ...
            Try
                ...
                If Not IsNothing(args) Then 'we will get list of all Test types for the disease.
                ...
                End If
                Dim oTuple = oService.GetData(GetCurrentCountry(), TEST_DISEASE_GET_LIST_SP, oCommon.KeyValPairToString(optionalParameters))
                ds = oTuple.m_Item1
                ds.CheckDataSet()
        ...
        Public Function SelectOne(dblId As Double) As DataSet Implements IEidssEntity.SelectOne
            ...
            Try
                ...
                optionalParameters.Add(New clsCommon.Param() With {.ParamName = "@LangID", .ParamValue = GetCurrentLanguage(), .ParamMode = "IN"})
                Dim oTuple = oService.GetData(GetCurrentCountry(), TEST_DISEASE_GET_DETAIL_SP, oCommon.KeyValPairToString(optionalParameters) & parameters)
                ds = oTuple.m_Item1
                ds.CheckDataSet()
