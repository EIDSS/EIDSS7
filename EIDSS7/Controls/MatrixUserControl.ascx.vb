...
Public Class MatrixUserControl
    ...
    Sub LoadTableData(params As String)
    ...
    '    Dim matrixVersions = ConfigurationApiClient.GetHumanAggregateCaseReportVersion()
    ...
    Public Shared Function SaveVersion(params As AggregateCaseVerionPostParams) As ConfHumanAggregateCaseMatrixVersionPostModel
        ...
        Try
            params.idfsMatrixType = ReferenceEditorType.Disease
            Dim sb As New StringBuilder()
    ...
    Public Shared Function DeleteMatrixRecord(params As Long) As String
        ...
        Try
            ...
            Dim ConfigApiCLient As ConfigurationServiceClient
            ConfigApiCLient = New ConfigurationServiceClient()
            Dim res = ConfigApiCLient.HumanAggReportDeleteMatrixRecord(params).Result
            If res.Count > 0 Then
    ...
    Public Shared Function SaveMatrix(params As String) As String
        ...
        Dim result As List(Of ConfHumanAggregateCaseMatrixReportPostModel)
        Try
            Dim Post As List(Of HumanCaseMtxReportPostParams) = Json.JsonConvert.DeserializeObject(Of List(Of HumanCaseMtxReportPostParams))(params)
            Dim ConfigApiCLient As ConfigurationServiceClient
            ConfigApiCLient = New ConfigurationServiceClient()
            result = ConfigApiCLient.SaveHumanAggregateCaseReportMatrix(Post).Result
    ...
    '    Dim ConfigApiCLient As ConfigurationServiceClient
    '    ConfigApiCLient = New ConfigurationServiceClient()
    '    Dim matrixVersions = ConfigApiCLient.GetHumanAggregateCaseReportVersion()
    '    Dim sb As New StringBuilder()
