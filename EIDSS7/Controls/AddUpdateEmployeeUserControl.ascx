<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="AddUpdateEmployeeUserControl.ascx.vb" Inherits="EIDSS.AddUpdateEmployeeUserControl" %>
...
<asp:UpdatePanel ID="upAddUpdateEmployee" runat="server" UpdateMode="Conditional">
    ...
    <ContentTemplate>
        ...
        <div class="panel panel-default">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3" runat="server" meta:resourcekey="Dis_Date_Last_Saved">
                    <label for="txtDateEntered"><% =GetGlobalResourceObject("Labels", "Lbl_Date_Last_Saved_Text") %></label>
                    <asp:TextBox ID="txtModificationDate" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox>
                </div>
            </div>
            <div class="panel-body">
                <div id="divEmployeeForm" runat="server" class="row embed-panel">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="sectionContainer expanded">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6" runat="server" meta:resourcekey="Dis_Personal_ID_Type">
                                                        ...
                                                        <eidss:DropDownList ID="ddlPersonalIDType" runat="server" CssClass="form-control"></eidss:DropDownList>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group" meta:resourcekey="Dis_Another_Address">
                                                ...
                                                <div class="input-group">
                                                    <div class="btn-group">
                                                        <asp:RadioButton ID="rdbAnotherAddressYes" runat="server" GroupName="AnotherAddress" CssClass="radio-inline" AutoPostBack="true" OnCheckedChanged="AnotherAddress_CheckedChanged" CausesValidation="false" meta:resourceKey="Lbl_Yes" />
                                                        <asp:RadioButton ID="rdbAnotherAddressNo" runat="server" GroupName="AnotherAddress" CssClass="radio-inline" AutoPostBack="true" OnCheckedChanged="AnotherAddress_CheckedChanged" CausesValidation="false" meta:resourceKey="Lbl_No" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" meta:resourcekey="Dis_Persons_Phone_Number">
                                                <label for="hdftxtContactPhone" runat="server" meta:resourcekey="Lbl_Persons_Phone_Number"></label>
                                                <div class="row">
                                            ...
                                            <div class="form-group" meta:resourcekey="Dis_Person_Another_Phone">
                                                ...
                                                <div class="input-group">
                                                    <div class="btn-group">
                                                        <asp:RadioButton ID="rdbAnotherPhoneYes" runat="server" GroupName="AnotherPhone" CssClass="radio-inline" AutoPostBack="true" OnCheckedChanged="AnotherPhone_CheckedChanged" meta:resourceKey="Lbl_Yes" />
                                                        <asp:RadioButton ID="rdbAnotherPhoneNo" runat="server" GroupName="AnotherPhone" CssClass="radio-inline" AutoPostBack="true" OnCheckedChanged="AnotherPhone_CheckedChanged" meta:resourceKey="Lbl_No" />
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div id="divSelectablePreviewDiseaseList" class="panel panel-default" runat="server">
                                        <div class="panel-heading">
                                            <div class="row">
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="gvHumanDiseaseReports" runat="server" AllowPaging="false" AllowSorting="false" AutoGenerateColumns="false" CssClass="table table-striped" ShowHeaderWhenEmpty="true" DataKeyNames="HumanDiseaseReportID" EmptyDataText="<%$ Resources: Labels, Lbl_No_Results_Found_Text %>" meta:Resourcekey="Grd_Disease_List" ShowFooter="true" GridLines="None" OnRowCommand="HumanDiseaseReports_RowCommand">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="EnteredDate" ReadOnly="true" DataFormatString="{0:d}" HeaderText="<%$ Resources: Labels, Lbl_Date_Entered_Text %>" />
                                    ...
                                    <div id="divSelectablePreviewOutbreakList" class="panel panel-default" runat="server">
                                        <div class="panel-heading">
                                            <div class="row">
                                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
                            ...
                            <eidss:SideBarNavigation ID="EmployeeSideBar" runat="server">
                                <MenuItems>
        ...
        <asp:HiddenField ID="hdfEmployeePanelController" runat="server" Value="0" />
    </ContentTemplate>
</asp:UpdatePanel>