...
Public Class MeasureReferenceEditorUserControl
...
#Region "buttons"
    ...
    Protected Sub btnSaveMeasures_ServerClick(ByVal sender As Object, ByVal e As EventArgs) Handles btnSaveMeasure.Click
        Try
            ...
            Else
                ...
                Else
                    ...
                    ScriptManager.RegisterClientScriptBlock(Me, Me.GetType(), "modalFieldTest", "$(function(){ showModal('errorReference2');});", True)
