<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="SearchEmployeeUserControl.ascx.vb" Inherits="EIDSS.SearchEmployeeUserControl" %>
...
<asp:UpdatePanel ID="upSearchPerson" runat="server" UpdateMode="Conditional">
    ...
    <ContentTemplate>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4" runat="server" meta:resourcekey="Dis_Date_Of_Birth_From">
                                            ...
                                            <eidss:CalendarInput ID="txtDateOfBirthFrom" runat="server" ContainerCssClass="input-group datepicker" CssClass="form-control" LinkedPickerID="txtDateOfBirthTo" ClientIDMode="Static" />
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-4 col-xs-4" runat="server" meta:resourcekey="Dis_Date_Of_Birth_To">
                                            ...
                                            <eidss:CalendarInput ID="txtDateOfBirthTo" runat="server" ContainerCssClass="input-group datepicker" CssClass="form-control" ClientIDMode="Static" />
                    ...
                    <asp:UpdatePanel ID="upSearchResults" runat="server">
                        ...
                        <ContentTemplate>
                            <div class="table-responsive">
                                <asp:GridView ID="gvHumanMaster" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="table table-striped" DataKeyNames="HumanMasterID" ShowHeaderWhenEmpty="true" ShowHeader="true" EmptyDataText="<%$ Resources: Labels, Lbl_No_Results_Found_Text %>" ShowFooter="False" GridLines="None" AllowPaging="true" PagerSettings-Visible="false">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources: Labels, Lbl_Person_ID_Text %>" SortExpression="EIDSSPersonID">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="btnSelectHumanMaster" runat="server" Text='<%# Eval("EIDSSPersonID") %>' Visible='<%# IIf(hdfSelectMode.Value = "7", True, False) %>' CommandName="Select" CommandArgument='<%# Eval("HumanMasterID").ToString() + "," + Eval("EIDSSPersonID") + "," + Eval("FullName") %>' CausesValidation="false"></asp:LinkButton>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="<%$ Resources: Labels, Lbl_Person_ID_Text %>" SortExpression="EIDSSPersonID">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="btnSelectHuman" runat="server" Text='<%# Eval("EIDSSPersonID") %>' Visible='<%# IIf(hdfSelectMode.Value = "7", True, False) %>' CommandName="Select" CommandArgument='<%# Eval("HumanID").ToString() + "," + Eval("EIDSSPersonID") + "," + Eval("FullName") %>' CausesValidation="false"></asp:LinkButton>
                            ...
                            <div id="divPager" class="row" runat="server">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
        ...
        <div class="modal-footer text-center">
            ...
            <asp:Button ID="btnSearch" runat="server" CssClass="btn btn-primary" Text="<%$ Resources: Buttons, Btn_Search_Text %>" ToolTip="<%$ Resources: Buttons, Btn_Search_ToolTip %>" ValidationGroup="SearchPerson" OnClientClick="showSearchLoading();" data-loading-text="Loading..." />
        ...
        <script type="text/javascript">
            ...
            function showSearchLoading() {
                var btn = $("#EIDSSBodyCPH_ucSearchEmployee_btnSearch")
                btn.button('loading')
            }

            function resetSearchButton() {
                $("#EIDSSBodyCPH_ucSearchEmployee_btnSearch").button('reset');
            }
        </script>
    </ContentTemplate>
</asp:UpdatePanel>