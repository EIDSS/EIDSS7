<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="FFHumanAggregateMatrix.ascx.vb" Inherits="EIDSS.FFHumanAggregateMatrix" %>
...
<%--This line is what holds the ObservationID and this is only one created, but FormTypeID and ObservationID are used to retrieve the FormTemplateID--%>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanelHumanAggregateMatrix">
        <ContentTemplate>
            ...
            <fieldset>
                ...
                <asp:Panel runat="server" ID="pnlHumanAggregateMatrix" Width="100%">
                </asp:Panel>
