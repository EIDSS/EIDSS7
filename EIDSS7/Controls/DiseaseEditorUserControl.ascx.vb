...
Public Class DiseaseEditorUserControl
...
#Region "buttons"
    ...
    Protected Sub btnSaveDiagnosis_ServerClick(ByVal sender As Object, ByVal e As EventArgs)
        Try
...
#End Region
    ...
    Protected Sub ShowAddDiseaseBtn_Click(sender As Object, e As EventArgs)
