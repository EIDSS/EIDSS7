<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NormalView.Master" CodeBehind="BaseReference.aspx.vb" Inherits="EIDSS.BaseReference" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="EIDSSBodyCPH" runat="server">
    <asp:UpdatePanel ID="refList" runat="server">
        <ContentTemplate>
            ...
            <div id="addBaseReference" class="modal" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" runat="server" meta:resourcekey="hdg_Base_Reference"></h4>
                        ...
                        <div class="modal-footer text-center">
                            <button type="submit" runat="server" meta:resourcekey="btn_Submit" data-dismiss="modal" class="btn btn-primary" id="btnSaveBaseReference" />
