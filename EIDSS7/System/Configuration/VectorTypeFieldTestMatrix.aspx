<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NormalView.Master" CodeBehind="VectorTypeFieldTestMatrix.aspx.vb" Inherits="EIDSS.VectorTypeFieldTestMatrix" %>
<asp:Content ID="Content1" ContentPlaceHolderID="EIDSSHeadCPH" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="EIDSSBodyCPH" runat="server">
	<asp:UpdatePanel runat="server" ID="upVectorTypeFieldTestMatrix">
		<ContentTemplate>
			<div class="panel-default">
				<div class="panel-heading">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<h2 runat="server" meta:resourcekey="hdg_Vector_Type_Field_Test_Matrix"></h2>
						</div>
					</div>
				</div>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-7">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button class="btn" type="submit" runat="server" id="btnAddVectorType">
							...
							<div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 text-right">
								<br />
								<asp:Button ID="btnAddVectorTypeFieldTest" runat="server" CssClass="btn btn-default btn-sm" meta:resourcekey="btn_Add" />
							</div>
						</div>
					</div>
					<div class="table-responsive">
						<asp:GridView runat="server"
							ID="gvVectorTypeFieldTestMatrix"
							AutoGenerateColumns="False"
							CssClass="table table-striped"
							ShowHeaderWhenEmpty="true"
							ShowHeader="true"
							DataKeyNames="idfPensideTestTypeForVectorType, idfsVectorType, idfsPensideTestName"
							GridLines="None"
							AllowSorting="false"
							AllowPaging="true"
							PageSize="20"
							meta:resourceKey="gv_VectorTypeFieldTestMatrix">
							...
							<Columns>
								...
								<asp:TemplateField HeaderText='<%$ Resources:lbl_Test_Name.InnerText %>'>
									<ItemTemplate>
										<asp:Label ID="lblstrPensideTestName" runat="server" Text='<%# Eval("strPensideTestName") %>' ></asp:Label>
									</ItemTemplate>
								</asp:TemplateField>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" runat="server" meta:resourcekey="hdg_Vector_Type_Field_Test_Matrix"></h4>
                        </div>
			...
			<div id="addPensideTestName" class="modal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" runat="server" meta:resourcekey="hdg_Vector_Type_Field_Test_Matrix"></h4>
                        ...
                        <div class="modal-body" runat="server">
                            <p runat="server" meta:resourcekey="lbl_Field_Test_Instructions"></p>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <span class="glyphicon glyphicon-certificate text-danger"></span>
                                        <label runat="server" meta:resourcekey="lbl_English_Value"></label>
                                        <asp:TextBox ID="txtPTNstrDefault" CssClass="form-control" runat="server" />
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <span class="glyphicon glyphicon-certificate text-danger"></span>
                                        <label runat="server" meta:resourcekey="lbl_Translated_Value"></label>
                                        <asp:TextBox ID="txtPTNstrName" CssClass="form-control" runat="server" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <asp:ListBox ID="lstPTNHACode" CssClass="form-control listbox" SelectionMode="Multiple" runat="server" />
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <label runat="server" meta:resourcekey="lbl_Order"></label>
                                        <eidss:NumericSpinner ID="txtPTNintOrder" CssClass="form-control" runat="server" MinValue="0" />
                                        <small runat="server" meta:resourceKey="lbl_Blank_Order"></small>
                                    </div>
                                </div>
                            </div>
                            <asp:HiddenField ID="hdfPTNValidationError" runat="server" Value="False" />
                        </div>
                        <div class="modal-footer">
                            <button type="submit" runat="server" class="btn btn-primary" meta:resourcekey="btn_Submit" id="btnAddPensideTest" data-dismiss="modal" />
                            <button type="submit" runat="server" class="btn btn-default" meta:resourcekey="btn_Cancel" id="btnCancelPensideTest" data-dismiss="modal" />
                        </div>
                    </div>
                </div>
            </div>
			<div id="addVectorTypeFieldTest" class="modal">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" runat="server" meta:resourcekey="hdg_Vector_Type_Field_Test_Matrix"></h4>
						...
						<div class="modal-body" id="sampleType" runat="server">
							<p runat="server" meta:resourcekey="lbl_Vector_Type_Field_Test_Instructions"></p>
							<div class="form-group">
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<span class="glyphicon glyphicon-certificate text-danger"></span>
										...
										<div class="input-group">
											<asp:DropDownList ID="ddlidfsPensideTestName" CssClass="form-control" runat="server" AppendDataBoundItems="true"></asp:DropDownList>
											<span class="input-group-btn">
												<button class="btn" type="submit" runat="server" data-dismiss="modal" id="btnAddPensideTestName">
													<span class="glyphicon glyphicon-plus"></span>
												</button>
											</span>
										</div>
							...
							<asp:HiddenField ID="hdfVTFTValidationError" runat="server" Value="False" />
							<asp:HiddenField ID="hdfVTFTidfPensideTestTypeForVectorType" runat="server" Value="NULL" />
						</div>
						<div class="modal-footer">
							<button type="submit" runat="server" class="btn btn-primary" meta:resourcekey="btn_Submit" id="btnSubmitVectorTypeFieldTestMatrix" data-dismiss="modal" />
							<button type="submit" runat="server" class="btn btn-default" meta:resourcekey="btn_Cancel" data-dismiss="modal" id="btnCancelVectorTypeFieldTest" />
						</div>
					</div>
				</div>
			</div>
