<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NormalView.Master" CodeBehind="VectorTypeSampleTypeMatrix.aspx.vb" Inherits="EIDSS.VectorTypeSampleTypeMatrix" %>

<asp:Content ID="Content1" ContentPlaceHolderID="EIDSSHeadCPH" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="EIDSSBodyCPH" runat="server">
	<asp:UpdatePanel runat="server" ID="upVectorTypeSampleTypeMatrix">
		<ContentTemplate>
			<div class="panel-default">
				<div class="panel-heading">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<h2 runat="server" meta:resourcekey="hdg_Vector_Type_Sample_Type_Matrix"></h2>
						</div>
					</div>
				</div>
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-lg-3 col-md-3 col-sm-4 col-xs-5 text-right">
								<br />
								<asp:Button ID="btnAddVectorTypeSampleTypeMatrix" runat="server" CssClass="btn btn-default btn-sm" meta:resourcekey="btn_Add" />
							</div>
						</div>
					</div>
					<div class="table-responsive">
						<asp:GridView runat="server"
							ID="gvVectorTypeSampleTypeMatrix"
							AutoGenerateColumns="False"
							EmptyDataText="No data available."
							CssClass="table table-striped"
							ShowHeaderWhenEmpty="true"
							ShowHeader="true"
							DataKeyNames="idfSampleTypeForVectorType, idfsVectorType, idfsSampleType"
							GridLines="None"
							AllowSorting="false"
							AllowPaging="true"
							PageSize="20"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" runat="server" meta:resourcekey="hdg_Vector_Type_Sample_Type_Matrix"></h4>
                        </div>
			...
			<div id="addVectorTypeSampleType" class="modal">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" runat="server" meta:resourcekey="hdg_Vector_Type_Sample_Type_Matrix"></h4>
						...
						<div class="modal-body" id="sampleType" runat="server">
							<p runat="server" meta:resourcekey="lbl_Vector_Type_Sample_Type_Instructions"></p>
							<div class="form-group">
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<span class="glyphicon glyphicon-certificate text-danger"></span>
							...
							<asp:HiddenField ID="hdfVTSTValidationError" runat="server" Value="False" />
							<asp:HiddenField ID="hdfVTSTidfSampleTypeForVectorType" runat="server" Value="NULL" />
						</div>
						<div class="modal-footer">
							<button type="submit" runat="server" class="btn btn-primary" meta:resourcekey="btn_Submit" id="btnSubmitVectorTypeSampleTypeMatrix" data-dismiss="modal" />
							<button type="submit" runat="server" class="btn btn-default" meta:resourcekey="btn_Cancel" data-dismiss="modal" id="btnCancelVectorTypeSampleType" />
						</div>
					</div>
				</div>
			</div>
