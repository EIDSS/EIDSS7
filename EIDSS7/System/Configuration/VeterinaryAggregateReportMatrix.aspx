<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="VeterinaryAggregateReportMatrix.aspx.vb" MasterPageFile="~/NormalView.Master" Inherits="EIDSS.VeterinaryAggregateReportMatrix"  meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="EIDSSBodyCPH" runat="server">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-3">
                    <asp:Label ID="Label1" runat="server" CssClass="form-control" meta:resourcekey="VersionNameTxtResource1"></asp:Label>
                    <br />
                    <asp:TextBox ID="VersionNameTxt" CssClass="form-control" ClientIDMode="Static" runat="server" ></asp:TextBox>
                </div>
                <div class="col-md-3">
                    <asp:Label ID="Label2" runat="server" CssClass="form-control" meta:resourcekey="ActivationDateResource1"></asp:Label>
                    <br />
                ...
                <div class="col-md-6">
                    <asp:Label ID="Label3" runat="server" CssClass="form-control" meta:resourcekey="SelectVersionResource1"></asp:Label>
                    <br />
    ...
    <div class="panel panel-default">
        <div class="panel-heading ">
            ...
            <h2>
                <asp:Label ID="Label5" runat="server" Text="Veterinary Aggregate Report Matrix" meta:resourcekey="Label5Resource1"></asp:Label></h2>
        ...
        <div class="panel-body">
            ...
            <asp:Table ID="HumanAggregateCaseTable" ClientIDMode="Static" runat="server" CssClass="table dataTable" meta:resourcekey="HumanAggregateCaseTableResource1">
                <asp:TableHeaderRow TableSection="TableHeader" VerticalAlign="Top" meta:resourcekey="TableHeaderRowResource1">
                    ...
                    <asp:TableHeaderCell Width="20%" meta:resourcekey="TableHeaderCellResource3">OIE Code</asp:TableHeaderCell>
                    <asp:TableHeaderCell Width="20%" meta:resourcekey="TableHeaderCellResource3">Species</asp:TableHeaderCell>
       ...
       /*Version Methods */
        ...
        function SaveMatrix() {
            ...
            table.rows().eq(0).each(function (index) {
                ...
                var selectedVersion = $("#VersionDropDown").gorillaDropdown("selected");
             // alert(row.data()[4]);
                if (row.data()[4] != undefined & row.data()[4] != "" & row.data()[5] != undefined & row.data()[5] != "" ) {
                    NewMatrixItem.intNumRow = row.data()[0];
                    NewMatrixItem.idfVersion = selectedVersion.value;
                    NewMatrixItem.idfsDiagnosis = row.data()[4];
                    NewMatrixItem.idfsSpeciesType = row.data()[5];
                    NewMatrixItem.idfAggrVetCaseMTX = row.data()[6];
                    MatrixObjectList.push(NewMatrixItem);
                    Duplicates.push(row.data()[4] +  row.data()[5] + row.data()[6]);
                }
            });
        ...
        function GetMatrixByVersion(versionId) {
            //alert(versionId);
            var endpoint = baseRoute + '/api/Configuration/ConfAdminAggregateVetCaseMatrixReportGet?Version';
            // console.log(baseRoute);
            $.ajax({
                url: endpoint,
                type: 'GET',
        ...
        function BuildTableWithData(data) {
            ...
            for (var i = 0; i < deserializedHumanDiseaseObj.length; i++) {
                ...
                if (deserializedHumanDiseaseObj[i].strOIECode == undefined) {
                    item.push(""); 
                }
                else {
                ...
                item.push(deserializedHumanDiseaseObj[i].idfsSpeciesType); 
                item.push(deserializedHumanDiseaseObj[i].idfsDiagnosis);
                item.push(deserializedHumanDiseaseObj[i].idfsSpeciesType);
                item.push(deserializedHumanDiseaseObj[i].idfAggrVetCaseMTX.toString());
                ...
                //tableRow.strOIECode = deserializedHumanDiseaseObj[i].strOIECode;
                //tableRow.idfsSpeciesType = deserializedHumanDiseaseObj[i].idfsSpeciesType;
                //tableRow.strDefault = deserializedHumanDiseaseObj[i].strDefault;
                //tableRow.idfAggrVetCaseMTX = deserializedHumanDiseaseObj[i].idfAggrVetCaseMTX;
            ...
            table = $('#HumanAggregateCaseTable').DataTable({
                ...
                columnDefs: [
...

                    {
                        ...
                        //Disease
                        targets: [1], render:
                            function (data, type, row, meta) { return createDiagnosis(data, type, row, meta); }
                    },
                    {
                        //OIE
                    ...
                    {
                        //MatrixID
                        targets: [6], type: "dom-text", render: function (data, type, row, meta) {
                            return data;
                        },
                        visible: false
                    }
        ...
        function DeleteMatrixRecord() {
            ...
            var data = row.data()[6];// ... do something with data(), or row.node(), etc
            if (row.data()[6] != undefined & row.data()[6] != "") {
                NewMatrixItem.intNumRow = row.data()[0];
                NewMatrixItem.idfVersion = selectedVersion.value;
                NewMatrixItem.idfsDiagnosis = row.data()[4];
                NewMatrixItem.idfsSpeciesType = row.data()[5];
            ...
            PageMethods.DeleteMatrixRecord(NewMatrixItem.idfAggrVetCaseMTX, onDeleteMatrixSucess, onDeleteMatrixError);
        ...
        function createDiagnosis(data, type, row, meta) {
            var rowId = meta.row;
            //console.log(meta);
