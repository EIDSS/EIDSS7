<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NormalView.Master" CodeBehind="DiseasePensideTestMatrix.aspx.vb" Inherits="EIDSS.DiseasePensideTestMatrix" %>
<asp:Content ID="Content1" ContentPlaceHolderID="EIDSSHeadCPH" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="EIDSSBodyCPH" runat="server">
    <asp:UpdatePanel runat="server" ID="upDiseasePensideTestList">
        <ContentTemplate>
            <div class="panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h2 runat="server" meta:resourcekey="hdg_Disease_Penside_Test_Matrix"></h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-right">
                                <asp:Button ID="btnAddDiseasePensideTestMatrix" runat="server" CssClass="btn btn-default btn-sm" meta:resourcekey="btn_Add" />
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <asp:GridView runat="server"
                            ID="gvDiseasePensideTest"
                            AutoGenerateColumns="False"
                            EmptyDataText="No data available."
                            CssClass="table table-striped"
                            ShowHeaderWhenEmpty="true"
                            ShowHeader="true"
                            DataKeyNames="idfPensideTestForDisease, idfsDiagnosis, idfsPensideTestName"
                            GridLines="None"
                            AllowSorting="false"
                            AllowPaging="true"
                            PageSize="20">
                            ...
                            <Columns>                                
                                ...
                                <asp:TemplateField HeaderText='<%$ Resources:lbl_Disease.InnerText %>'>
                                    <ItemTemplate>
                                        <asp:Label ID="lblstrDisease" runat="server" Text='<%# Bind("strDisease") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText='<%$ Resources:lbl_Test_Name.InnerText %>'>
                                    <ItemTemplate>
                                        <asp:Label ID="lblstrPensideTestName" runat="server" Text='<%# Bind("strPensideTestName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            <div id="addDiseasePensideTest" class="modal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" runat="server" meta:resourcekey="hdg_Disease_Penside_Test_Matrix"></h4>
                        </div>
                        <div class="modal-body" id="sampleType" runat="server">
                            <p runat="server" meta:resourcekey="lbl_Disease_Penside_Test_Instructions"></p>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <asp:DropdownList ID="ddlidfsPensideTestName" CssClass="form-control" runat="server" AppendDataBoundItems="true"></asp:DropdownList>
                                            <span class="input-group-btn">
                                                <button class="btn" type="submit" runat="server" data-dismiss="modal" id="btnAddTestName" meta:resourceKey="btn_Test_Name">
                                                    <span class="glyphicon glyphicon-plus"></span>
                                                </button>
                                            </span>
                                        </div>
                            ...
                            <asp:HiddenField ID="hdfDPTValidationError" runat="server" Value="False" />
                            <asp:HiddenField ID="hdfDPTidfsPensideTestforDisease" runat="server" Value="NULL" />
                        </div>
                        <div class="modal-footer">
                            <button type="submit" runat="server" class="btn btn-primary" meta:resourcekey="btn_Submit" data-dismiss="modal" id="btnSubmitDiseasePensideTest" />
                            <button type="submit" runat="server" class="btn btn-default" meta:resourcekey="btn_Cancel" data-dismiss="modal" id="btnCancelDiseasePensideTest" />
                        </div>
                    </div>
                </div>
            </div>
