<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NormalView.Master" CodeBehind="DiseaseGroupDiseaseMatrix.aspx.vb" Inherits="EIDSS.DiseaseGroupDiseaseMatrix" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="EIDSSBodyCPH" runat="server">
    <asp:UpdatePanel runat="server" ID="upDiseaseGroupDiseaseMatrix">
        <ContentTemplate>
                ...
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h2 runat="server" meta:resourcekey="hdg_Disease_Group_Disease_Matrix"></h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6">
                                <label runat="server" meta:resourcekey="lbl_Disease_Group"></label>
                                <div class="input-group">
                                    <asp:DropDownList ID="ddlidfsDiagnosisGroup" runat="server" CssClass="form-control" AutoPostBack="true" AppendDataBoundItems="true"></asp:DropDownList>
                                    <span class="input-group-btn">
                                        <button class="btn" type="submit" runat="server" data-dismiss="modal" id="btnAddDiseaseGroup">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-lg-offset-6 col-md-offset-6 col-sm-offset-2 text-right">
                                <br />
                                <asp:Button ID="btnAddDiseaseGroupDiseaseMatrix" runat="server" CssClass="btn btn-default btn-sm" meta:resourcekey="btn_Add" />
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <asp:GridView runat="server"
                            ID="gvDiseaseGroupDiseaseMatrix"
                            AutoGenerateColumns="False"
                            EmptyDataText="No data available."
                            CssClass="table table-striped"
                            ShowHeaderWhenEmpty="true"
                            ShowHeader="true"
                            DataKeyNames="idfDiagnosisToDiagnosisGroup, idfsDiagnosisGroup, idfsDiagnosis"
                            GridLines="None"
                            AllowSorting="false"
                            AllowPaging="true"
                            PageSize="20"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText='<%$ Resources:lbl_Disease.InnerText %>'>
                                    <ItemTemplate>
                                        <asp:Label ID="lblstrDiseaseName" runat="server" Text='<%# Bind("strDiseaseName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField>
                                    <HeaderTemplate>
            ...
            <div id="addDiseaseGroupDisease" class="modal">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" runat="server" meta:resourcekey="hdg_Disease_Group_Disease_Matrix"></h4>
                        </div>
                        <div class="modal-body" id="sampleType" runat="server">
                            <p runat="server" meta:resourcekey="lbl_Disease_Group_Disease_Instructions"></p>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <asp:HiddenField ID="hdfDGDValidationError" runat="server" Value="False" />
                            <asp:HiddenField ID="hdfDGDidfDiagnosisToDiagnosisGroup" runat="server" Value="NULL" />
                            <asp:HiddenField ID="hdfDGDstrName" runat="server" Value="NULL" />
                        </div>
                        <div class="modal-footer">
                            <button type="submit" runat="server" class="btn btn-primary" meta:resourcekey="btn_Submit" id="btnSubmitDiseaseGroupDiseaseMatrix" data-dismiss="modal" />
                            <button type="submit" runat="server" class="btn btn-default" meta:resourcekey="btn_Cancel" data-dismiss="modal" id="btnCancelDiseaseGroupDisease" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="addDiseaseGroup" class="modal" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" runat="server" meta:resourcekey="hdg_Disease_Group_Disease_Matrix"></h4>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <span class="glyphicon glyphicon-certificate text-danger"></span>
                                        <label runat="server" meta:resourcekey="lbl_English_Value"></label>
                                        <asp:TextBox ID="txtDGstrDefault" CssClass="form-control" runat="server" />
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <span class="glyphicon glyphicon-certificate text-danger"></span>
                                        <label runat="server" meta:resourcekey="lbl_Translated_Value"></label>
                                        <asp:TextBox ID="txtDGstrName" CssClass="form-control" runat="server" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <asp:ListBox ID="lstDGHACode" CssClass="form-control listbox" SelectionMode="Multiple" runat="server" />
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <label runat="server" meta:resourcekey="lbl_Order"></label>
                                        <eidss:NumericSpinner ID="txtDGintOrder" CssClass="form-control" runat="server" MinValue="0" />
                                        <small runat="server" meta:resourcekey="lbl_Blank_Order"></small>
                                    </div>
                                </div>
                            </div>
                            <asp:HiddenField ID="hdfDGValidationError" runat="server" Value="False" />
                        </div>
                        <div class="modal-footer">
                            <button type="submit" runat="server" class="btn btn-primary" meta:resourcekey="btn_Submit" data-dismiss="modal" id="btnSubmitDiseaseGroup" />
                            <button type="submit" runat="server" class="btn btn-default" meta:resourcekey="btn_Cancel" data-dismiss="modal" id="btnCancelDiseaseaGroup" />
                        </div>
                    </div>
                </div>
            </div>
