...
{
    public class SearchLivestockDiseaseReportPage
    {
        ...
        public class SearchParameters
        {
            ...
            private static By btnCreateLivestockRpt = By.Id(CommonCtrls.SearchVetDiseaseContent + "btnAddLivestockVeterinaryDiseaseReport");
                        ...
                        {
                            {
                                ...
                                if (Driver.Instance.FindElement(titleFormTitle).Text.Contains("Search Parameters") &&
                                    Driver.Instance.FindElement(titleFormTitle).Displayed)
                                    return true;
                                else
                                    Driver.Instance.Navigate().GoToUrl((string)Driver.BaseAddress);
            ...
            public static void clickCreateLivestockDiseaseRpt()
            {
                //Scroll to bottom of the page
                ((IJavaScriptExecutor)Driver.Instance).ExecuteScript("window.scrollBy(0, 700)", "");
                SetMethods.clickObjectButtons(btnCreateLivestockRpt);
            }
