...
{
    public class VectorSpeciesTypesEditorPage
    {
        ...
        private static By btnCancelSave_12 = By.XPath("//*[@id='EIDSSBodyCPH_gvVectorSubType']/tbody/tr[13]/td[7]/a");
        private static By btnPopupOK = By.XPath("//*[@id='successModal']/div/div/div[3]/button");
        private static By btnDelete_12 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_btnDelete_11");
        private static By lblEngValue_12 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_lblstrDefault_11");
        private static By btnEdit_12 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_btnEdit_11");
        private static By lblOrder_12 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_lblintOrder_11");
        private static By btnEdit_4 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_btnEdit_3");
        private static By btnEdit_10 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_btnEdit_9");
        private static By lblOrder_4 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_lblOrder_4");
        private static By txtOrder_4 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_txtOrder_4");
        private static By lblTransValue_4 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_lblstrName_3");
        private static By txtTransValue_4 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_txtstrName_3");
        private static By lblTransValue_10 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_lblstrName_9");
        private static By txtTransValue_10 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_txtstrName_9");
        private static By lblTransValue_12 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_lblstrName_11");
        private static By txtTransValue_12 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_txtstrName_11");
        private static By lblCode_4 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_lblstrCode_3");
        private static By txtCode_4 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_txtstrCode_3");
        private static By lblCode_12 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_lblstrCode_11");
        private static By txtCode_12 = By.Id(CommonCtrls.GeneralContent + "gvVectorSubType_txtstrCode_11");
        private static By btnPopupErrOK = By.Id(CommonCtrls.GeneralContent + "btnErrorOK");
        private static By ddlVectorType = By.Id(CommonCtrls.GeneralContent + "ddlVectorType");
        private static IList<IWebElement> vectorTypeOpts { get { return Driver.Instance.FindElements(By.XPath("//*[@id='" + CommonCtrls.GeneralContent + "ddlVectorType']/option")); } }
        public static String refValue1 = null;
        public static String refValue2 = null;
        private static By btnSave_4 = By.XPath("//*[@id='" + CommonCtrls.GeneralContent + "gvVectorSubType']/tbody/tr[5]/td[6]/a");
        private static By btnSave_10 = By.XPath("//*[@id='" + CommonCtrls.GeneralContent + "gvVectorSubType']/tbody/tr[11]/td[7]/a");
        ...
        public static bool IsAt
        {
            get
            {
                ...
                else if (Driver.Instance.FindElements(titleFormTitle).Count > 0)
                {
                    {
                        Thread.Sleep(5000);
                        if (Driver.Instance.FindElement(titleFormTitle).Text.Contains("Vector Species Types List") &&
        ...
        //    SetMethods.enterObjectValue(txtIVS10_4, value + codeValue);
        ...
        public static void getTwelfthVectorSpeciesTypeTransValue()
        {
        ...
        public static void getTwelfthCodeNoInGrid()
        {
            SetMethods.GetNewvalue4(lblCode_12);
        }
        ...
        {
            SetMethods.enterObjectValue(ddlVectorType, value);
        }

        public static void randomSelectVectorTypeThatContainVEC()
        {
            SetMethods.randomSelectObjectElementThatContains(ddlVectorType, vectorTypeOpts, "VEC");
        }
        ...
        public class VectorSpeciesTypePopupWndw
        {
            private static By titleFormTitle = By.TagName("h4");
            private static By txtEnglishValue = By.Id(CommonCtrls.GeneralContent + "txtVSstrDefault");
            private static By txtTransValue = By.Id(CommonCtrls.GeneralContent + "txtVSstrName");
            private static By txtCode = By.Id(CommonCtrls.GeneralContent + "txtVSstrCode");
            private static By txtOrder = By.Id(CommonCtrls.GeneralContent + "txtVSintOrder");
            private static By btnSubmit = By.Id(CommonCtrls.GeneralContent + "btnSaveVectorSubType");
            private static By btnCancel = By.Id(CommonCtrls.GeneralContent + "btnCancelVectorSubType");
                    ...
                    {
                        {
                            ...
                            if (Driver.Instance.FindElement(titleFormTitle).Text.Contains("Vector Species Type") &&
                                Driver.Instance.FindElement(titleFormTitle).Displayed)
                                return true;
                            else
                                return false;
            ...
            public static void enterManualCodeValue()
            {
                SetMethods.enterObjectValue(txtCode, SetMethods.refValue4);
            }
